<!DOCTYPE html>
                            ...
                            <head>
                                ...
                                <meta property="title" content="Digital Marketing">
                                ...
                                <link rel="icon" type="image/png" sizes="32x32" href="{{ url("images/favicon-icon/40898.png") }}">
                            ...
                            <body>
                                <header class="main-header bg-white position-fixed w-100 start-0 top-0">
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                        <div class="container">
                                            <a class="navbar-brand w-25" href="#"><img class="w-75" src="{{ url("images/logo/9936.png") }}" alt=""></a>
