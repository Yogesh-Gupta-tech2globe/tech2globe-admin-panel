<!DOCTYPE html>
                            ...
                            <head>
                                ...
                                <link rel="icon" type="image/png" sizes="32x32" href="{{ url("images/favicon-icon/77237.png") }}">
                ...
                <header class="main-header bg-white position-fixed w-100 start-0 top-0">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <div class="container">
                            <a class="navbar-brand w-25" href="#"><img width="auto" height="50px" src="{{ url("images/logo/2875.png") }}" alt=""></a>
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a class="nav-link active" aria-current="page" href="#main-kuhkjkjohj">Main kuhkjkjohj</a>
                                    </li>
                                    <li class="nav-item">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                <p>&copy; Copyright 2023 Tech2globe All rights reserved. Yogesh</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <style>
                    .section-a {
                        background: url("images/background/90430.jpg");
                        ...
                        <div class="container">
                            <div class="row sub-section-a d-flex justify-content-between align-items-center">
                                <div class="col-md-7 col-lg-7 col-xl-7 col-xxl-7 col-sm-12 col-xs-12">
                                    <h1 class="text-dark main-heading">Virtual Assistants Are the Solution For Your Business Yogesh</h1>
                                    <p class="" style="color: #f26e4f;">Get In Touch With Us Today</p>
                                    <div class="button-container">
                                        <a href="#contact-us" class="main-button">GET STARTED now</a>
                                ...
                                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-sm-12 col-xs-12">
                                    <figure class="w-100">
                                        <img class="w-100" style="border-radius: 20px; height: 300px;" src="{{ url("images/banner/59669.png") }}" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="section-b" id="our-services">
                        <div class="container padding-block-container">
                            <div class="row d-flex justify-content-center">
                                <h3 class="text-center heading-3">Virtual Assistant Services We Offer in Website</h3>
                                ...
                                <p class="text-center pt-2 pb-2">Curb the struggle of managing extensive administration tasks, and scale your business growth with contemporary solutions. Hire virtual assistants from the global service provider Tech2Globe Web Solutions. We utilize the latest tools, techniques, and processes to provide world-class and 100% accurate services. Furthermore, we allocate you tech-savvy and proactive VAs that have aptitude in various fields to run admin errands for you and support challenges that you may be facing. Our comprehensive solutions include, but are not limited to</p><div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                                    <div class="card">
                                        <div class="heading-container">
                                            <figure class="icon w-25">
                                                <img class="w-100" src="{{ url("images/icons/47380.jpeg") }}" alt="">
                                            </figure>
                                            <div class="heading-4">
                                        ...
                                        <div class="content-container text-center">
                                            ...
                                            <a href="data-entry-services" class="sub-button">Read More</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="heading-container">
                                            <figure class="icon w-25">
                                                <img class="w-100" src="{{ url("images/icons/56454.jpg") }}" alt="">
                                            </figure>
                                            <div class="heading-4">
                                                <h4 class="text-dark text-center">ergrerfer</h4>
                                            </div>
                                        </div>
                                        <div class="content-container text-center">
                                            <p class="text-dark">refwe</p>
                                            <a href="ergrerfer" class="sub-button">Read More</a>
                                        </div>
                                    </div>
                                </div></div>
                        </div>
                ...
                <!-- why should you hire start -->
                    <section class="section-c padding-block-container" id="why-choose">
                        <h3 class="text-center heading-3">Why Should You Hire Virtual Assistants From Tech2gobe? Yogesh</h3>
                        ...
                        <div class="container">
                            <div id="counter" class="row">
                                <div class="col-lg-2 col-xl-2 col-xxl-2 col-md-4 col-sm-12 col-xs-12">
                                    <div class="item">
                                        <span class="count">YK#</span>
                                        <p class="text">Cost Reductionuu</p>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xl-2 col-xxl-2 col-md-4 col-sm-12 col-xs-12">
                                    <div class="item">
                                ...
                                <div class="col-lg-2 col-xl-2 col-xxl-2 col-md-4 col-sm-12 col-xs-12">
                                    <div class="item">
                                        ...
                                        <p class="text">Accuracy ke sarh</p>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-xl-2 col-xxl-2 col-md-4 col-sm-12 col-xs-12">
                                    <div class="item">
                ...
                <!-- valued customer start -->
                    <section class="section-d padding-block-container" id="our-customers">
                        <h3 class="text-center heading-3">Our Valued Customers Yogesh</h3>
                        ...
                        <div class="container mt-2">
                            <div class="row my-5 text-center d-flex justify-content-between align-items-center our-valued-customer gap-4"><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/66879.png") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/57295.jpg") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div>
                            </div>
                        </div>
                ...
                <!-- testimonial end -->
                        <style>
                          #our-contact {
                              ...
                              background-image: url("/images/background/36811.jpeg");
                ...
                <!-- contact us section-f end -->
                       ...
                       .have-query-section {
                            ...
                            background-image: url("/images/background/90218.jpeg");
                            background-blend-mode: multiply;
                        ...
                        <section class="section-g">
                          <div class="have-query-section">
                              <div class="container-fluid" id="have_queries">
                                  <div class="row">
                                      <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                          <h3 class="text-extra-dark-gray mb-3 font-weight-700 md-w-100 d-block text-center text-white main-heading">Have Queries? Yogesh</h3>
                                          <small class="text-white text-center w-100 d-block pb-5">Get A Call Back Today!</small>
