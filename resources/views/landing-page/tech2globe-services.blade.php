<!DOCTYPE html>
                            ...
                            <head>
                                ...
                                <meta property="title" content="tech2globe">
                                <meta name="description" content="our tech2globe description" />
                                <meta name="keywords" content="tech2globe services keyword">
                                <meta name="author" content="tech2globe">
                                <link rel="icon" type="image/png" sizes="32x32" href="{{ url("images/favicon-icon/9433.png") }}">
                                <title>tech2globe services</title>
                            ...
                            <body>
                                <header class="main-header bg-white position-fixed w-100 start-0 top-0">
                                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                        <div class="container">
                                            <a class="navbar-brand w-25" href="#"><img class="w-75" src="{{ url("images/logo/7242.jpg") }}" alt=""></a>
