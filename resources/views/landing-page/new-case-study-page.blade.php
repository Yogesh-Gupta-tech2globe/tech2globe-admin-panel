<!DOCTYPE html>
                            ...
                            <head>
                                ...
                                <meta property="title" content="Mongo db a new database">
                                <meta name="description" content="jwenwoenoi" />
                                <meta name="keywords" content="Unonikana mazurisana">
                                <meta name="author" content="tech2globe">
                                <link rel="icon" type="image/png" sizes="32x32" href="{{ url("images/favicon-icon/67056.png") }}">
                                <title>New Case study Page</title>
                ...
                <header class="main-header bg-white position-fixed w-100 start-0 top-0">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <div class="container">
                            <a class="navbar-brand w-25" href="#"><img width="auto" height="50px" src="{{ url("images/logo/25342.png") }}" alt=""></a>
                ...
                <style>
                    .section-a {
                        background: url("images/background/58263.jpg");
                            ...
                            <div class="row sub-section-a d-flex justify-content-between align-items-center">
                                <div class="col-md-7 col-lg-7 col-xl-7 col-xxl-7 col-sm-12 col-xs-12">
                                    ...
                                    <div class="button-container">
                                        <a href="#contact-us" class="main-button">GET STARTED</a>
                                ...
                                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-sm-12 col-xs-12">
                                    <figure class="w-100">
                                        <img class="w-100" style="border-radius: 20px; height: 300px;" src="{{ url("images/banner/26310.jpg") }}" alt="">
                                    </figure>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <p class="text-center pt-2 pb-2">Curb the struggle of managing extensive administration tasks, and scale your business growth with contemporary solutions. Hire virtual assistants from the global service provider Tech2Globe Web Solutions. We utilize the latest tools, techniques, and processes to provide world-class and 100% accurate services. Furthermore, we allocate you tech-savvy and proactive VAs that have aptitude in various fields to run admin errands for you and support challenges that you may be facing. Our comprehensive solutions include, but are not limited to</p><div class="col-md-4 col-lg-3 col-xl-3 col-xxl-3 col-sm-12 col-xs-12 card-container-section-b">
                                    <div class="card">
                                        <div class="heading-container">
                                            <figure class="icon w-25">
                                                <img class="w-100" src="{{ url("images/icons/") }}" alt="">
                                            </figure>
                                            <div class="heading-4">
                                    ...
                                    <div class="card">
                                        <div class="heading-container">
                                            <figure class="icon w-25">
                                                <img class="w-100" src="{{ url("images/icons/86778.png") }}" alt="">
                                            </figure>
                                            <div class="heading-4">
                                        ...
                                        <div class="content-container text-center">
                                            <p class="text-dark">ihbisudhbisud</p>
                    ...
                    <section class="section-d padding-block-container" id="our-customers">
                        ...
                        <div class="container mt-2">
                            <div class="row my-5 text-center d-flex justify-content-between align-items-center our-valued-customer gap-4"><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/94593.jpg") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/45991.jpg") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/7028.jpeg") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/82616.png") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div><div class="col-lg-2 col-md-4 col-sm-6 col-xs-6">
                                        <figure>
                                            <img src="{{ url("images/customers/83593.webp") }}" alt="" height="80" width="auto">
                                        </figure>
                                    </div>
                            </div>
                        </div>
                ...
                <!-- testimonial end -->
                        <style>
                          #our-contact {
                              ...
                              background-image: url("/images/background/66713.jpg");
                ...
                <!-- contact us section-f end -->
                       ...
                       .have-query-section {
                            ...
                            background-image: url("/images/background/66732.jpeg");
                            background-blend-mode: multiply;
                              ...
                              <div class="container-fluid" id="have_queries">
                                  <div class="row">
                                      <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                          <h3 class="text-extra-dark-gray mb-3 font-weight-700 md-w-100 d-block text-center text-white main-heading">Have Queries?</h3>
