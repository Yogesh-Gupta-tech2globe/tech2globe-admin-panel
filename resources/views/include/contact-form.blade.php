...
<style>
    ...
    @media (max-width: 1023px) {
        ...
        #contact-form .g-recaptcha.mt-1.ps-0 {
...
<div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col" id="contact-form">

    <h3 class="text-left pb-2 text-dark px-3">Get a FREE Quote!</h3>
    ...
    <div class="col-md-12 pt-1">
        ...
        <form name='contact1' method="POST" action="include/banner-mail" id='contact-us1'>
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 boxes px-0">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 boxes px-0">
                    ...
                    <div class="form-group px-2">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="Enter Email*" name="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" required>
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 boxes px-0">
                    ...
                    <div class="form-group newform px-2">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 boxes px-0">
                    ...
                    <div class="form-group px-2">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Mobile No*" name="phone" minlength="10" maxlength="11" required>
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 boxes px-2">
                    ...
                    <textarea name="comment" class="form-control-text" id="iq" placeholder="Enter your query*" rows="5" required></textarea>
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 boxes px-2">
                    ...
                    <input type="submit" value="Submit" name="submit" class="btn btn-default text-white bg-dark mt-2" />
