            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <a style="max-width: 200px; float: right;" href="" class="btn btn-block btn-primary mt-2" id="portfoliocategoryaddbtn" data-toggle="modal" data-target="#add-category">Add Portfolio Category</a>
                  @endif
                </div>
                <!-- /.card-header -->
                <div class="card-body">
