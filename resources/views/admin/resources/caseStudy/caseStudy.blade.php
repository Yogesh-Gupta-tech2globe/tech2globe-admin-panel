            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  @endif
                  <a style="max-width: 150px; float: right;" href="{{ url('admin/resources/case-study-category') }}" class="btn btn-block btn-primary mt-2 mx-2">Category</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        @foreach($casestudy as $row)
                            <tr>
                              ...
                              <td>
                                  @if ($pagesModule['edit_access']==1 || $pagesModule['full_access']==1)
                                  @if ($row['r_status']==1)
                                      <a class="updateRCasestudyStatus" id="casestudy-{{ $row['id'] }}" casestudy_id="{{ $row['id'] }}" href="javascript:void(0)"><i class="fas fa-toggle-on" status="Active"></i></a>
                                  @else
                                      <a class="updateRCasestudyStatus" id="casestudy-{{ $row['id'] }}" casestudy_id="{{ $row['id'] }}" style="color: grey;" href="javascript:void(0)"><i class="fas fa-toggle-off" status="Inactive"></i></a>
                                  @endif
                                  &nbsp;&nbsp;
                                  @endif
                                  @if ($pagesModule['edit_access']==1 || $pagesModule['full_access']==1)
                                  <a href="{{ url('admin/resources/edit-case-study/'.$row['id']) }}"><i class="fas fa-edit"></i></a>
                                  &nbsp;&nbsp;
                                  @endif
                              </td>
                            </tr>
  ...
  <div class="modal fade" id="add-casestudy">
    <div class="modal-dialog">
      <div class="modal-content bg-secondary">
        <form action="add-case-study" method="post" enctype="multipart/form-data">@csrf
