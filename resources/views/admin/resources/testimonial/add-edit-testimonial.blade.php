          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                ...
                <form @if(empty($testimonial['id'])) action="{{ url('admin/resources/add-edit-testimonial') }}" @else action="{{ url('admin/resources/add-edit-testimonial/'.$testimonial['id']) }}" @endif method="post" enctype="multipart/form-data">@csrf
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        <input type="checkbox" name="r_status" @if(empty($testimonial['id'])) checked @else @if($testimonial['r_status'] != 0) checked @endif @endif>
