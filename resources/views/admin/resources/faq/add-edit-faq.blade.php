          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                ...
                <form @if(empty($faq['id'])) action="{{ url('admin/resources/add-edit-faq') }}" @else action="{{ url('admin/resources/add-edit-faq/'.$faq['id']) }}" @endif method="post" enctype="multipart/form-data">@csrf
                    <div class="card-body">
