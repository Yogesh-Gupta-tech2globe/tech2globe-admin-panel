          ...
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <div class="card card-primary">
                ...
                @endif
                <!-- form start -->
                <form action="{{ url('admin/update-details') }}" method="post" enctype="multipart/form-data">@csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="admin_name" id="admin_name" value="{{ Auth::guard('admin')->user()->name }}" placeholder="Enter Admin Name">
                    </div> 
                    <div class="form-group">
